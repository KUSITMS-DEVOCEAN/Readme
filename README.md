...
A팀 → 알파벳의 첫번째 → 자음의 첫번째 → ㄱ

`개발(IT)의 바다에서 1등이 되자`라는 의미를 내포하고 있습니다.

# ⭐️ R&R 분배

| **분야** | **이름** | **포지션** |
| --- | --- | --- |
| 기획 | **이현수** | 📈 기획 리드, 서비스 정책 확립, 타서비스 벤치마킹 |
| 기획 | **안수영** | 📊 서비스 정책 확립, 데스크 리서치 |
| 기획 | **오준희** | 📋 서비스 정책 확립, UX Writing |
| 디자인 | **김승은** | 🔐 디자인 리드, GUI디자인, UX/UI 디자인, 그래픽 디자인 |
| 디자인 | **정의연** | 📢 GUI디자인, UX/UI 디자인, 그래픽 디자인 |
| 프론트 | **성태현** | 🔦 개발 리드, 화면 UI 구현, 서버 연동 |
| 프론트 | **최호** | 📱 PM, 화면 UI 구현, 서버 연동 |
| 백엔드 | **윤소민** | 💻 DB 및 API 구축, 서버 배포 |
| 백엔드 | **이건** | 🖥️ DB 및 API 구축, 서버 배포 |
